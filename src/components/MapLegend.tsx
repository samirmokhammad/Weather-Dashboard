...
export default function MapLegend({ mapType }: Props) {
  ...
  return (
    <div className="absolute top-4 right-4 z-1001 w-48 xs:w-96 rounded-xl p-4 shadow-lg bg-background/50 border-accent flex flex-col gap-3">
      <h3 className="text-sm font-semibold text-foreground">{data.title}</h3>
      <div
        className="w-full rounded-xl border-accent h-6"
        style={{
